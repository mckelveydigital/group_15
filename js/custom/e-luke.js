...
$(document).on('click', '.player', function(e) {
	...
	$.each(players, function(index, item) {  
		...
		if(item.id === player_id){
			...
			$("#player_info .player_info_name").html(item.first_name + " " + item.last_name);
	
			$("#player_info .player_info_position").html(item.position);
			
			$("#player_info .player_info_country").html(item.nationality);
			
			$("#player_info .player_info_dob").html(item.date_of_birth);
			
			$("#player_info .player_info_shirt").html(item.shirt_number);
			
		}
		
	});
	
	$("#player_info").addClass("on");
	
});

$(document).on('click', '#player_info_close', function(e) {
	
	$("#player_info").removeClass("on");
